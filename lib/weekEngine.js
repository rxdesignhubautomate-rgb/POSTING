...
export function weeklyBrief(slot,channel,settings,brand=channel.brand){
  ...
  return {
    ...
    notes:[slot.topic.notes,`Persona: ${persona.label}. ${persona.voice}`,`Brand dashboard: ${brandLabel}`].filter(Boolean).join('\n'),
